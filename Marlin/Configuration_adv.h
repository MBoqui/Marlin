...
// before setting a PWM value. (Does not work with software  for fan on Sanguinololu)
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 1.06    // Unit: mm compression per 1mm/s extruder speed
